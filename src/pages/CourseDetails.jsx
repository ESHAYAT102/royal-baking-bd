      ...
      <Container>
        <div className="min-h-[60vh] flex items-center justify-center">
          <div role="status">
            <svg
              aria-hidden="true"
              class="w-8 h-8 text-gray animate-spin fill-[#e5cddf]"
              viewBox="0 0 100 101"
              fill="none"
    ...
    <Container>
      <div className="py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold mb-8">{course.name}</h1>
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="p-8">
              <div className="text-2xl font-bold mb-4">{course.price} BDT</div>
